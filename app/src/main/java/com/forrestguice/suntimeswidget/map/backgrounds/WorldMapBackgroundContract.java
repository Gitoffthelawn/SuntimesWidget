...
public interface WorldMapBackgroundContract
{
    ...
    String COLUMN_BACKGROUND_TINT = "background_tint";                           // request tint flag (boolean as string)
    ...
    String COLUMN_BACKGROUND_PROJECTION_CENTER = "background_projection_center"; // lat,lon (string) (may be null)
